...
const goals = [
  {
    ...
    description: "Implement effective conservation for endangered heritage sites using best practices and innovative technology.",
  },
  {
    num: "02",
    title: "Research & Documentation",
    description: "Conduct research enhancing understanding of Lebanese heritage and meticulously document sites for posterity.",
  },
  {
    num: "03",
    title: "Community Engagement",
    description: "Actively involve local communities, empowering them as custodians of their history and culture.",
  },
  {
    num: "04",
    title: "Education & Awareness",
    description: "Raise public awareness of heritage significance and conservation importance through education.",
  },
  {
    num: "05",
    title: "Advocacy & Policy",
    description: "Advocate for stronger legal frameworks supporting heritage protection at all levels.",
  },
  {
    num: "06",
      ...
      <section className="py-24">
        <div className="container max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-border">
            {goals.map((goal) => (
              <div key={goal.num} className="bg-background p-8 md:p-10">
        ...
        <div className="container max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {featuredProjects.map((project, index) => (
              <Link href="/gallery" key={index} className="group block">
